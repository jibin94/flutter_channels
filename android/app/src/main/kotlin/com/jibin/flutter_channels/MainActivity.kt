package com.jibin.flutter_channels
...
class MainActivity: FlutterActivity() {
    private val eventChannel = "com.timeEvent"

    override fun configureFlutterEngine(flutterEngine: FlutterEngine) {
        super.configureFlutterEngine(flutterEngine)
        MethodChannel(flutterEngine.dartExecutor.binaryMessenger, "com.randomNumber").setMethodCallHandler {
                call, result ->
